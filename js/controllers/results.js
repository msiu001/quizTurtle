    ...
    angular
        ...
        function ResultsController(quizMetrics, DataService){
            ...
            function calculatePercentage(){
                ...
                scorePercentage = numberOfCorrectAnswers / DataService.quizQuestions.length * 100;
                return scorePercentage;


                //or only scorePercentage = quizMetrics.numberOfCorrectAnswer / DataService.quizQuestions.length *100;
            }
